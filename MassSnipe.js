...
var scriptConfig = {
    ...
    translations: {
      ...
      pt_PT: {
            'Mass Snipe': 'Snipe em massa',
            Help: 'Ajuda',
            'There was an error!': 'Ocorreu um erro!',
            'There was an error while fetching the data!':
                'Ocorreu um erro na procura dos dados!',
            'Redirecting...': 'Redirecionando...',
            'There was an error fetching villages by group!':
                'Ocorreu um erro na procura das aldeias no grupo!',
            'An error occured while fetching troop counts!':
                'Ocorreu um erro na procura da quantidade de tropas!',
            Village: 'Aldeia',
            'Landing Time': 'Hora de chegada',
            Sigil: 'Afli\u00e7\u00e3o',
            'Min. Amount': 'Quantidade m\u00edn.',
            Action: 'A\u00e7\u00e3o',
            'Add new Snipe': 'Add novo snipe',
            'Calculate Times': 'Calcular tempos',
            From: 'Origem',
            To: 'Destino',
            Unit: 'Unidade',
