...
var scriptConfig = {
    ...
    translations: {
       ...
       pt_PT: {
            'Defense Health Check': 'Calculadora de Defesa',
            Help: 'Ajuda',
            'Redirecting...': 'A redirecionar...',
            'This script needs to be run on village overview!':
                'Este Script deve ser utilizado na Visualização geral da Aldeia!',
            'There was an error fetching troops stationed on your village!':
                'Houve um erro a calcular as tropas desta aldeia!',
            'There was an error fetching simulation data!':
                'Houve um erro a recolher os dados da simulação!',
            'Check Stack Health': 'Calcular estado da defesa',
            'Take into account incoming support':
            ...
            'No nuke is killed!': 'Nenhum full é morto!',
            'Enable night bonus': 'Bonus Nocturno',
            'Run the script again on village overview!':
                'Corre o Script na Visualização geral da aldeia!',
            Reset: 'Reset',
            'Configuration was resetted!': 'Configuração resetada!',
            'Defense Villages': 'Aldeias de Defesa',
            'Nukes needed to clear': 'Fulls necessarios para limpar',
        },
    },
    allowedMarkets: [],
