...
var scriptConfig = {
    ...
    translations: {
      ...
      pt_PT: {
            'Fake Script Generator': 'Gerador de Fakes',
            Help: 'Help',
            'How to send fakes?': 'Como enviar os Fakes?',
            Randomly: 'Random',
            Sequential: 'Sequencial',
            'Selective Random': 'Random Selectivo',
            Coordinates: 'Coordenadas',
            'Choose units and amounts to send':
                'Escolhe as unidades e o número para enviar',
            'Generate Script': 'Gerar Script',
            'Coordinates field is required!': 'Campo de Coordenadas mandatório!',
            'You must choose at least one unit to send!':
                'Tens que escolher pelo menos uma unidade para enviar!',
            'Add this script to your Quick-bar':
                'Adiciona este Script na Barra de acesso rápido, necessita Premium',
            'Add new Link': 'Adicionar novo Link',
            'How to fill coordinates?': 'Como Preencher as Coordenadas?',
            Manually: 'Manual',
            Automatically: 'Automático',
            'Player (separate players using comma)':
                'Jogador (separar jogadores por virgulas)',
            'Tribo (separate tribes using comma)':
                'Tribe (separar Tribo por virgulas)',
            'Start typing and suggestions will show ...':
                'Começa a escrever e as sugestões vão aparecer ...',
            'You must select at least one player or one tribe!':
                'Necessitas de selecionar pelo menos um Jogador ou Tribo!',
            Continents: 'Continentes',
            'Min Coord': 'Min Coord',
            'Max Coord': 'Max Coord',
            'Dist from center': 'Distância do Centro',
            Center: 'Centro',
            'Script could not be generated since nothing could fit into specified criteria!':
                'Script não pode ser gerado porque não foram encontradas soluções para a criteria apresentada!',
            'Minimum coordinates and maximum coordinates filter should work together!':
                'Filtro do Min e Max de coordenadas deve funcionar em conjunto !',
            'Invalid user input!': 'Entrada invalida!',
            'Radius filtering needs both fields filled!':
                'O Filtro do Raio necessita dos dois campos preenchidos!',
            'What to send?': 'O que enviar?',
            Custom: 'Custom',
            'Send all': 'Enviar todos',
            'Selective Send all': 'Selecionar o que enviar',
            'Ram first then Catapult': 'Aríete primeiro e depois Catas',
            'Catapult first then Ram': 'Catas primeiro e depois Aríetes',
            'Fake Limit': 'Limite de Fakes',
            'Excluded Players': 'Jogadores excluídos',
            'Select units to send and what unit amounts to keep':
                'Seleciona as unidades para enviar e que quantidade reservar',
            'Configuration imported successfully!':
                'Configuração importada com sucesso!',
            'Nothing to import!': 'Nada para importar!',
            '20:1 No-Attack': '20:1 Não Atacar',
            'Filter players 20 times bigger then yourself':
                'Filtrar jogadores 20 vezes maior que eu',
            'Minimum Points Village': 'Minimo de pontos da aldeia',
            'Maximum Points Village': 'Maximo de pontos da aldeia',
            'Selective Random Configuration': 'Selecionar uma configuração Random',
            'This will target Player3 1000% more times then normal distribution, Player2 will be targetted 200% more and Player1 will be targetted 500% more.':
                'Esta Opção irá focar o Jogador3 1000% mais vezes que a distribuição normal, o jogador2 vai sere focado 200% mais e o jogador1 vai ser focado 500% mais.',
        },
    },
    allowedMarkets: [],
    allowedScreens: [],
